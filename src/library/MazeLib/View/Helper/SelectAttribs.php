...
/**
 * MazeLib_View_Helper_SelectAttribs
 * 
 * @license http://opensource.org/licenses/MIT MIT
 */
class MazeLib_View_Helper_SelectAttribs extends Zend_View_Helper_FormSelect
{
    /**
     ...
     */
    public function selectAttribs($name, $value = null, $attribs = null,
     ...
     */
    protected function _build($value, $label, $selected, $disable, array $attribs = null)
    {
        if (is_bool($disable)) {
            $disable = array();
        }
